...
router.post("/agregar", (req, res) => {
    ...
    request.execute("AsociaTEC_SP_Actividades_Agregar", (error, result) => {
        if (error) {
            ...
            res.status(200).send({mensaje:"Actividad agregada correctamente"})
        }
    })
})
...
router.put("/modificar", (req, res) => {
    ...
    request.execute("AsociaTEC_SP_Actividades_Agregar", (error, result) => {
        if (error) {
            ...
            res.status(200).send({mensaje:"Actividad modificada correctamente"})
        }
    })
})
...
router.delete("/eliminar", (req, res) => {
    ...
    request.execute("AsociaTEC_SP_Actividades_Eliminar", (error, result) => {
        if (error) {
            ...
            res.status(200).send({mensaje:"Actividad eliminada correctamente"})
        }
    })
})
