...
const RequestConfirmation = ({ handleClose, handleConfirm, title, confirmationText, confirmColor, modal, setDescripcion }) => {
                    ...
                    <div className="w-screen h-screen top-0 left-0 right-0 bottom-0 fixed z-[100]">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white shadow-md rounded-md z-[102] w-full max-w-sm py-6 px-4 pt-8" onClick={(e) => { e.preventDefault() }}>
                            <div className="content flex flex-col items-center">
                                ...
                                <p className="w-full text-center my-7">Descripción</p>
                                <input onChange={(e) => setDescripcion(e.target.value)} className="py-1 px-2 border border-venice-blue-700 rounded-lg bg-gray-50"/>
                            </div>
